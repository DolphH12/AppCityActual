...
class _OtpPageState extends State<OtpPage> {
        ...
        return Observer(
          builder: (_) => LoaderHUD(
            ...
            child: Scaffold(
              ...
              body: _contenidoOTP(loginStore, context),
            ),
          ),
        );
      },
  ...
  SafeArea _contenidoOTP(LoginStore loginStore, BuildContext context) {
    return SafeArea(
              child: Column(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                  ...
                                  child: Text('Ingrese el codigo de 6 digitos enviada a su numero.', style: TextStyle(color: Colors.black, fontSize: 26, fontWeight: FontWeight.w500))
                              ),
                              Container(
                          ...
                          child: RaisedButton(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text('Confirma', style: TextStyle(color: Colors.white),),
                                  Container(
