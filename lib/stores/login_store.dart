...
import 'package:muroappmod/pages/register_page.dart';
import 'package:muroappmod/pages/signup.dart';
...
abstract class LoginStoreBase with Store {
  ...
  Future<void> onAuthenticationSuccessful(BuildContext context, AuthResult result) async {
    ...
    preferenciasUsuario.token = result.user.phoneNumber.toString();
    Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (_) => SignupPage()), (Route<dynamic> route) => false);
  ...
  Future<void> signOut(BuildContext context) async {
    await _auth.signOut();
    await Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (_) => const LogintoPage()), (Route<dynamic> route) => false);
    firebaseUser = null;
  }
}